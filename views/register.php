    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content auth-card p-4">
            ...
            <form action="index.php?page=register" method="POST" enctype="multipart/form-data">
                <input type="text" name="name" placeholder="Nom de l'entreprise" class="form-control-custom" required>
                <input type="email" name="email" placeholder="Email" class="form-control-custom" required>
                <input type="text" name="siret" placeholder="N° de SIRET" class="form-control-custom" required>
                ...
                <div class="mb-3">
                    ...
                    <input type="file" id="kbisUpload" name="kbis" class="d-none">
                </div>

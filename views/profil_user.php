        ...
        <div class="card-body">
            ...
            <form id="profileForm" class="row g-3 needs-validation" novalidate>
                ...
                <div class="col-12 col-md-6">
                    ...
                    <input type="text" id="prenom" name="firstname" class="form-control" value="<?= $firstname ?>"
                        required>
                </div>
                ...
                <div class="col-12 col-md-6">
                    <label for="password" class="form-label">Nouveau mot de passe (laisser vide pour garder
                        l'actuel)</label>
                ...
                <div class="col-12 d-flex justify-content-end">
                    <button id="saveBtn" type="submit" class="btn-save"><i class="bi bi-save me-2"></i><span
                            id="saveTxt">Enregistrer</span></button>
                </div>
            </form>
        </div>
    </div>

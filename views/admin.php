  ...
  <div class="container-fluid">
    ...
    <div class="row">
      ...
      <nav class="col-md-3 col-lg-2 sidebar">
        ...
        <a href="index.php?page=admin&section=users">Utilisateurs</a>
        <a href="index.php?page=admin&section=offers">Offres</a>
        <a href="index.php?page=admin&section=companies">Entreprises</a>
        <a href="index.php?page=admin&section=jobs">Candidatures</a>
        <br><br>

      ...
      <tbody>
          <?php foreach ($companies as $company): ?>
              <tr>
                  ...
                  <td>
                      <a href="admin.php?section=companies&action=show&id=<?= $company['company_id'] ?>" class="btn btn-sm btn-info">Voir</a>
                      <a href="admin.php?section=companies&action=edit&id=<?= $company['company_id'] ?>" class="btn btn-sm btn-warning">Modifier</a>
                      <a href="admin.php?section=companies&action=delete&id=<?= $company['company_id'] ?>" 
                         class="btn btn-sm btn-danger"
                         onclick="return confirm('Voulez-vous vraiment supprimer l\'entreprise ?');">
                         Supprimer
                      </a>
                  </td>
              </tr>
